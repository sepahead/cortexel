  ...
  return /* @__PURE__ */ jsxs("section", { className, "aria-label": safeDiagnosticText(label, 240), children: [
    rows.length === 0 ? /* @__PURE__ */ jsx("p", { role: "status", children: "No graph nodes match this view." }) : /* @__PURE__ */ jsx("ul", { children: visibleRows.map(({ node, relationIndexes }, rowOffset) => {
      ...
      return /* @__PURE__ */ jsxs("li", { children: [
        ...
        selectedId === node.id && omitted > 0 && /* @__PURE__ */ jsx(
          RelationshipPager,
          {
            nodeId: node.id,
            relationIndexes,
...
function RelationshipPager({
  ...
  return /* @__PURE__ */ jsxs("details", { children: [
    ...
    /* @__PURE__ */ jsx("ul", { children: relationIndexes.slice(start, start + RELATION_PAGE_SIZE).map((edgeIndex) => /* @__PURE__ */ jsx("li", { children: relationshipText(nodeId, edges[edgeIndex], byId) }, `${edgeIndex}-${nodeId}`)) }),
    /* @__PURE__ */ jsxs("p", { "aria-live": "polite", children: [
      "Page ",
      page + 1,
      " of ",
...
function KnowledgeGraph3DScene({
  ...
  const { simNodes, simLinks, validEdges, index, warmStart } = useMemo2(() => {
  ...
  const flowEdges = useMemo2(() => validEdges.filter((e) => e.particles), [validEdges]);
  ...
  const linePos = useMemo2(() => new Float32Array(validEdges.length * 6), [validEdges]);
  const lineCol = useMemo2(() => new Float32Array(validEdges.length * 6), [validEdges]);
