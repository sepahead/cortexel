...
function renderKnowledgeGraph3DScene(props) {
	...
	const hoverId = view !== void 0 && props.hoverId !== null && !knowledgeGraphViewContainsNode$1(view, presentation, props.hoverId) ? null : props.hoverId;
...
function KnowledgeGraphAccessibleFigure(props) {
	...
	return /* @__PURE__ */ jsx(KnowledgeGraphCorpusFrameInternal, {
		...
		className,
		label,
		renderPrimaryRegion: (context) => /* @__PURE__ */ jsx(KnowledgeGraphInteractiveRegion, {
			context,
			renderVisual,
			visualAvailable,
			visualRetryKey,
