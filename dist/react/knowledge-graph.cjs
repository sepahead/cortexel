...
function KnowledgeGraphA11yList(props) {
  ...
  assertRenderableGraphEdges(nodes, edges);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KnowledgeGraphA11yListInstance, { ...props }, graphIdentity);
}
...
function KnowledgeGraph3DScene(props) {
  ...
  assertUniqueGraphNodeIds(nodes);
  assertRenderableGraphEdges(nodes, edges);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(KnowledgeGraph3DSceneInstance, { ...props }, graphIdentity);
}
function KnowledgeGraph3DSceneInstance({
  ...
  const queryMatchIds = (0, import_react2.useMemo)(
    () => graphQueryMatchIds(nodes, normalizedQuery, edges),
    [nodes, edges, normalizedQuery]
  );
  const queryActive = normalizedQuery.length > 0;
  const { simNodes, simLinks, validEdges, edgeLanes, index, warmStart } = (0, import_react2.useMemo)(() => {
