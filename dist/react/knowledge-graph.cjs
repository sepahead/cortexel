...
function renderKnowledgeGraphStaticRecordView(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(KnowledgeGraphStaticRecordViewInstance, { ...props }, staticRecordInstanceKey(props.presentation));
}
...
function KnowledgeGraphAccessibleFigure(props) {
	...
	const selectedIsInvalid = preparedSource.ok && preparedView.ok && selectedId !== null && !(preparedView.view === void 0 ? (0, _cortexel_knowledge_graph_presentation_capability.knowledgeGraphPresentationContainsNode)(preparedSource.presentation, selectedId) : (0, _cortexel_knowledge_graph_presentation_capability.knowledgeGraphViewContainsNode)(preparedView.view, preparedSource.presentation, selectedId));
	const hoverIsInvalid = preparedSource.ok && preparedView.ok && hoverId !== null && !(preparedView.view === void 0 ? (0, _cortexel_knowledge_graph_presentation_capability.knowledgeGraphPresentationContainsNode)(preparedSource.presentation, hoverId) : (0, _cortexel_knowledge_graph_presentation_capability.knowledgeGraphViewContainsNode)(preparedView.view, preparedSource.presentation, hoverId));
	(0, react.useEffect)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("figure", {
		...
		children: [
			...
			visualAvailable && liveForceAvailable && scene !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(KnowledgeGraphVisualBoundary, {
...
exports.DEFAULT_A11Y_NODE_PAGE_SIZE = DEFAULT_A11Y_NODE_PAGE_SIZE;
...
exports.KnowledgeGraphA11yList = KnowledgeGraphA11yList;
exports.KnowledgeGraphAccessibleFigure = KnowledgeGraphAccessibleFigure;
exports.KnowledgeGraphLegend = KnowledgeGraphLegend;
...
exports.KnowledgeGraphStaticRecordView = KnowledgeGraphStaticRecordView;
exports.MAX_A11Y_NODE_PAGE_SIZE = MAX_A11Y_NODE_PAGE_SIZE;
