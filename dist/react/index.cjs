...
function usePopulationExpand(controlled) {
	...
	const [localHovered, setLocalHovered] = (0, react.useState)(null);
	...
	return {
		...
		toggleSelected: (0, react.useCallback)((id) => setSelectedPopId(selectedPopId === id ? null : id), [selectedPopId, setSelectedPopId]),
...
function ExpandablePopulation({ position, color, isSelected, isAnySelected, isHovered, onHover, onClick, themeMode, size = .3, reducedMotion = false }) {
	...
	const ringRef = (0, react.useRef)(null);
	const initialScale = isSelected ? 0 : isAnySelected ? .5 : 1;
	const initialOpacity = isSelected ? 0 : isAnySelected ? .05 : 1;
	const scaleRef = (0, react.useRef)(initialScale);
	const opacityRef = (0, react.useRef)(initialOpacity);
	const onHoverRef = (0, react.useRef)(onHover);
	(0, react.useEffect)(() => {
		onHoverRef.current = onHover;
	}, [onHover]);
	(0, react.useEffect)(() => () => onHoverRef.current(false), []);
	const colorObj = (0, react.useMemo)(() => new three.Color(color), [color]);
	const voxelColor = (0, react.useMemo)(() => colorObj.clone().multiplyScalar(.82), [colorObj]);
	const ringColor = (0, react.useMemo)(() => themeMode === "light" ? colorObj.clone().multiplyScalar(.8) : colorObj.clone(), [colorObj, themeMode]);
	...
	(0, _react_three_fiber.useFrame)((state, delta) => {
		let targetScale = 1;
		let targetOpacity = 1;
		if (isSelected) {
			targetScale = 0;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("group", {
		position,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("mesh", {
			ref: meshRef,
			onPointerOver: (e) => {
				e.stopPropagation();
				onHover(true);
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("mesh", {
			ref: ringRef,
			rotation: [
				-Math.PI / 2,
				0,
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ringGeometry", { args: [
				ringInner,
				ringOuter,
				32
			] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("meshBasicMaterial", {
...
function ExpandableNeurons({ count, center = [
	...
	const grid = (0, react.useMemo)(() => neuronLocalGrid(count, spacing), [count, spacing]);
	const activity = (0, react.useMemo)(() => {
	...
	const pointsRef = (0, react.useRef)(null);
	const previousExpandedRef = (0, react.useRef)(expanded);
	const onHoverRef = (0, react.useRef)(onHoverNeuron);
	(0, react.useEffect)(() => {
		onHoverRef.current = onHoverNeuron;
	}, [onHoverNeuron]);
	(0, react.useEffect)(() => () => onHoverRef.current?.(null), []);
	(0, react.useEffect)(() => {
	...
	(0, react.useEffect)(() => () => material.dispose(), [material]);
	const initiallyExpanded = expanded && reducedMotion;
	const expansionRef = (0, react.useRef)(initiallyExpanded ? 1 : 0);
	const opacityRef = (0, react.useRef)(initiallyExpanded ? 1 : 0);
	(0, react.useLayoutEffect)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("points", {
		ref: pointsRef,
		geometry,
		material,
		position: center,
...
function PopulationA11yList({ populations, selectedId, onSelect, label = "Neural populations" }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
		...
		children: populations.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
			role: "status",
			children: "No populations are available."
		}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", { children: populations.map((population) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			type: "button",
			...
			children: require_knowledgeGraphLimits.safeDiagnosticText(population.label, 240)
		}), population.description && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [" ", require_knowledgeGraphLimits.safeDiagnosticText(population.description, 500)] })] }, population.id)) })
	});
}
...
function NeuronA11yPager({ count, selectedIndex, onSelect, pageSize = 50, getLabel = (index) => `Neuron ${index + 1}`, label = "Neurons" }) {
	...
	const [page, setPage] = (0, react.useState)(selectedIndex === null ? 0 : Math.floor(selectedIndex / safePageSize));
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
		"aria-label": require_knowledgeGraphLimits.safeDiagnosticText(label, 240),
		children: count === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
			role: "status",
			children: "No neurons are available."
		}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", { children: Array.from({ length: end - start }, (_, offset) => start + offset).map((index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			type: "button",
			...
			children: require_knowledgeGraphLimits.safeDiagnosticText(getLabel(index), 240)
		}) }, index)) }), pageCount > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("nav", {
...
//#endregion
exports.DEFAULT_NEURON_A11Y_PAGE_SIZE = DEFAULT_NEURON_A11Y_PAGE_SIZE;
exports.ExpandableNeurons = ExpandableNeurons;
exports.ExpandablePopulation = ExpandablePopulation;
exports.MAX_INTERACTIVE_NEURON_POINTS = MAX_INTERACTIVE_NEURON_POINTS;
exports.MAX_NEURON_A11Y_PAGE_SIZE = MAX_NEURON_A11Y_PAGE_SIZE;
exports.MAX_NEURON_POINTS = MAX_NEURON_POINTS;
exports.MAX_POPULATION_SIZE = MAX_POPULATION_SIZE;
exports.NEURON_CLUSTER_SCALE = NEURON_CLUSTER_SCALE;
exports.NEURON_FRAG = NEURON_FRAG;
exports.NEURON_VERT = NEURON_VERT;
exports.NeuronA11yPager = NeuronA11yPager;
exports.PopulationA11yList = PopulationA11yList;
exports.VizSpecRenderer = require_VizSpecRenderer.VizSpecRenderer;
...
exports.validatePopulationGeometry = validatePopulationGeometry;
