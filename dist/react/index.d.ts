import { i as VizSpecRendererProps, n as RenderSceneArgs, r as VizSpecRenderer, t as CameraHint } from "../VizSpecRenderer-QFr-uskU.js";
...
//#endregion
//#region react/ExpandablePopulation.d.ts
...
declare function ExpandablePopulation({ position, color, isSelected, isAnySelected, isHovered, onHover, onClick, themeMode, size, reducedMotion }: ExpandablePopulationProps): import("react").JSX.Element;
//#endregion
//#region react/ExpandableNeurons.d.ts
...
declare function ExpandableNeurons({ count, center, color, spikeColor, expanded, themeMode, reducedMotion, spacing, selectedNeuronIndex, membraneIntensity, spikeIntensity, onHoverNeuron, onSelectNeuron }: ExpandableNeuronsProps): import("react").JSX.Element;
//#endregion
//#region react/SelectionA11yControls.d.ts
...
//#endregion
//#region react/neuronShaders.d.ts
...
//#endregion
export { AccessiblePopulationOption, CameraHint, DEFAULT_NEURON_A11Y_PAGE_SIZE, ExpandableNeurons, ExpandableNeuronsProps, ExpandablePopulation, ExpandablePopulationProps, MAX_INTERACTIVE_NEURON_POINTS, MAX_NEURON_A11Y_PAGE_SIZE, MAX_NEURON_POINTS, MAX_POPULATION_SIZE, NEURON_CLUSTER_SCALE, NEURON_FRAG, NEURON_VERT, NeuronA11yPager, NeuronGrid, PopulationA11yList, PopulationExpand, PopulationExpandController, RenderSceneArgs, VizSpecRenderer, VizSpecRendererProps, neuronExpandedScale, neuronLocalGrid, usePopulationExpand, validatePopulationGeometry };
