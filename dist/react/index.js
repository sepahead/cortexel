...
function VizSpecRenderer({
  ...
  const validation = useMemo3(() => effectiveSkillId !== void 0 ? {
    kind: "strict",
...
function ValidationError({
  ...
  const onInvocationErrorRef = useRef3(onInvocationError);
  const reportedKeyRef = useRef3(null);
  useEffect4(() => {
  ...
  return /* @__PURE__ */ jsxs3("div", { role: "alert", "aria-live": "assertive", className: "cortexel-vizspec-error", children: [
    /* @__PURE__ */ jsx4("strong", { children: title }),
    /* @__PURE__ */ jsx4("p", { children: "Fix the fields below and validate the visualization again." }),
    /* @__PURE__ */ jsx4("ul", { children: messages.map((message, index) => /* @__PURE__ */ jsx4("li", { children: message }, `${index}-${message}`)) })
  ] });
}
function SceneFrame({
  skill,
  ...
  if (mode === "export") {
    return /* @__PURE__ */ jsx4("div", { role: "status", className: "cortexel-vizspec-export-unsupported", children: "Headless export rendering is not available in this build. Request an interactive render, or use the backend render endpoint once enabled." });
  }
      ...
      children: [
        ...
        caption && /* @__PURE__ */ jsx4(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx4("bdi", { dir: "auto", style: { unicodeBidi: "isolate" }, children: caption })
          }
        )
      ]
    }
