...
function declaredInput(args, key) {
	...
	if (typeof value === "number" || value === true) return safeDiagnosticText(String(value), 120);
}
...
function metadataValue(value, limit = 180) {
	...
	if (typeof value === "number" || typeof value === "boolean") return safeDiagnosticText(String(value), limit);
	try {
...
function PaginatedChartData({ label, rowCount, rowAt, pageSize = DEFAULT_CHART_DATA_PAGE_SIZE, foreground, background }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			rows.length > 0 && /* @__PURE__ */ jsx("ol", {
				start: start + 1,
				children: rows.map((row) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("bdi", {
					dir: "auto",
		...
		children: [
			/* @__PURE__ */ jsxs("svg", {
				...
				children: [
					...
					children,
					legendEntries.length > 0 && /* @__PURE__ */ jsxs("g", {
						...
						}), legend.length > legendEntries.length && /* @__PURE__ */ jsxs("text", {
			...
			dataRows && /* @__PURE__ */ jsx(PaginatedChartData, {
			...
			(note || accessibleDetails.length > 0) && /* @__PURE__ */ jsxs("figcaption", {
				...
				children: [note && /* @__PURE__ */ jsx("div", { children: note }), accessibleDetails.length > 0 && /* @__PURE__ */ jsxs("div", {
					"aria-label": accessibleDetailsLabel,
					children: [/* @__PURE__ */ jsxs("span", { children: [accessibleDetailsLabel, ": "] }), accessibleDetails.join(" ")]
				})]
			})
		]
	});
...
function TraceChart(args, width, height, id) {
	...
	return /* @__PURE__ */ jsx(ChartShell, {
		...
		children: /* @__PURE__ */ jsx("g", {
			fill: "none",
			children: params.series.map((series, index) => /* @__PURE__ */ jsx("path", {
...
function RateResponseChart(args, width, height, id) {
	...
	return /* @__PURE__ */ jsxs(ChartShell, {
		id,
		skill: args.skill,
		scene: args.scene,
		title: "F–I response",
...
function HistogramChart({ args, width, height, id, title, description, metadata, xLabel, yLabel, centers, values, binWidth, color, alignmentLabel }) {
	...
	return /* @__PURE__ */ jsxs(ChartShell, {
		...
		children: [/* @__PURE__ */ jsx("path", {
			...
			strokeWidth: .75,
			vectorEffect: "non-scaling-stroke"
		}), alignmentLabel && zeroInDomain && /* @__PURE__ */ jsxs("g", {
...
function IsiChart(args, width, height, id) {
	const params = args.params;
	return /* @__PURE__ */ jsx(HistogramChart, {
		args,
		width,
		height,
		id,
...
function PlasticityChart(args, width, height, id) {
	...
	return /* @__PURE__ */ jsxs(ChartShell, {
		...
		children: [/* @__PURE__ */ jsx("path", {
			...
			strokeWidth: 2,
			vectorEffect: "non-scaling-stroke"
		}), params.weights.length === 1 && /* @__PURE__ */ jsx("path", {
...
function PhasePlaneChart(args, width, height, id) {
	...
	return /* @__PURE__ */ jsxs(ChartShell, {
		...
		children: [/* @__PURE__ */ jsx("path", {
			...
			vectorEffect: "non-scaling-stroke"
		}), zeroSamples.length > 0 && /* @__PURE__ */ jsx("path", {
...
function ReferenceChartScene(args) {
	const checked = useMemo(() => validateReferenceChartInput(args), [
		args.params,
		args.scene,
		args.skill
	]);
	if (!checked.ok) return /* @__PURE__ */ jsx(InvalidReferenceChartInput, { messages: checked.messages });
	return /* @__PURE__ */ jsx(CheckedReferenceChartScene, {
		...args,
		params: checked.params
	});
}
...
function CheckedReferenceChartScene(args) {
	const id = `cortexel-chart-${useId().replace(/[^a-zA-Z0-9_-]/g, "")}`;
	...
	switch (args.skill) {
		...
		default: return /* @__PURE__ */ jsx(UnsupportedReferenceChart, {
			skill: args.skill,
			scene: args.scene
		});
	}
...
function ReferenceVizSpecFigure({ spec, skillId, active = true, activePalette, width, height, onError, onInvocationError }) {
	return /* @__PURE__ */ jsx(VizSpecRenderer, {
		spec,
		skillId,
		active,
		activePalette,
		...
		renderScene: (args) => /* @__PURE__ */ jsx(CheckedReferenceChartScene, {
			...args,
			width,
			height
		})
