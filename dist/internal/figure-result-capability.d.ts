import { a as ValidateOptions, V as ValidatedRequest } from '../request-Cim-pRCp.js';
import { D as Disclosure } from '../disclosures-B1yMLt1i.js';
import { J as JsonValue } from '../catalog-C0useJAP.js';
 ...
 */
declare function isLiveBuiltFigureResult(value: unknown): value is FigureResult;
