...
function deriveDisclosures(facts, allowedIds, forced = []) {
	...
	const out = [];
	for (const rule of require_registry.DISCLOSURE_RULES) {
...
//#endregion
Object.defineProperty(exports, 'deriveDisclosures', {
  enumerable: true,
  get: function () {
    return deriveDisclosures;
  }
});
//# sourceMappingURL=disclosures-KX6A7VTY.cjs.map