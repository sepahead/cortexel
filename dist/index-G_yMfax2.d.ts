...
import { U as SceneName, V as SceneData, h as RendererRoute, m as NestSkillId, n as HostRendererInvocationResult, o as SkillInvocationError, p as NestDeviceFamily, s as SkillInvocationResult, t as HostRendererInvocation } from "./hostInvocation-DHtJIETG.js";
...
//#endregion
//#region core/skills/knowledgeGraphLimits.d.ts
/**
...
//#endregion
//#region core/skills/corpusKnowledgeGraph.d.ts
...
type EngramReceiptBoundCorpusEntityEdgeKind = Exclude<EngramCorpusEntityEdgeKind, 'same_as'>;
...
interface EngramReceiptBoundCorpusEntityGraphResponse {
...
declare function adaptEngramCorpusEntityGraph(graph: EngramCorpusEntityGraphResponse | EngramReceiptBoundCorpusEntityGraphResponse, options: AdaptEngramCorpusEntityGraphOptions): AdaptEngramCorpusEntityGraphResult;
declare function adaptEngramCorpusEntityGraph(graph: unknown, options: unknown): AdaptEngramCorpusEntityGraphResult;
//#endregion
//#region core/skills/registry.d.ts
...
declare const SKILL_REGISTRY: Record<"nest.animation_replay" | "nest.connectivity_matrix" | "nest.spatial_2d" | "nest.stimulus_response" | "nest.voltage_trace" | "nest.astrocyte_dynamics" | "nest.spike_raster" | "nest.population_rate" | "nest.rate_response" | "nest.isi_distribution" | "nest.psth" | "nest.correlogram" | "nest.weight_histogram" | "nest.plasticity_dynamics" | "nest.phase_plane" | "nest.connection_graph" | "nest.adjacency_matrix" | "nest.weight_matrix" | "nest.delay_matrix" | "nest.in_degree_distribution" | "nest.out_degree_distribution" | "nest.delay_distribution" | "nest.spatial_map_2d" | "nest.spatial_3d" | "nest.compartmental_dynamics" | "corpus.knowledge_graph", SkillContract>;
...
//#endregion
//#region core/skills/examples.d.ts
...
//#endregion
//#region core/skills/router.d.ts
...
//#endregion
//#region core/skills/authoring.d.ts
...
//#endregion
//#region core/skills/verify.d.ts
...
//#endregion
//#region core/nest/modelSemantics.d.ts
...
//#endregion
//#region core/nest/adapters.d.ts
type AdapterResult = {
  ok: true;
  data: SceneData;
...
//#endregion
//#region core/nest/topology.d.ts
...
//#endregion
export { CorrelationDetectorStatus as $, SkillDescriptor as $t, correlationDetectorToCorrelogramParams as A, declaredProvenanceValueError as An, ROUTING_DISCRIMINATORS as At, WeightRecorderTupleGroup as B, getInvocationExamplePayload as Bt, CorrelationDetectorSourceConfiguration as C, PROVENANCE_PARAM_CONSTRAINT_LANGUAGE as Cn, buildVizSpec as Ct, PopulationRateOptions as D, ProvenanceParamConstraint as Dn, Disambiguator as Dt, NestAnalysisResult as E, ProvenanceKeyEnum as En, validateSpec as Et, GetConnectionsSceneOptions as F, routeToScene as Ft, spikeRecorderToSceneData as G, PARAM_VALIDATION_CONSTRAINTS as Gt, getConnectionsToSceneData as H, ExternalProvenanceClaim as Ht, MultimeterSenderSeries as I, HOST_RENDERER_EXAMPLE_PAYLOADS as It, splitWeightRecorderBySynapse as J, ProvenanceVerificationKind as Jt, splitMultimeterBySender as K, ParamValidationConstraint as Kt, MultimeterSplitResult as L, SKILL_EXAMPLE_PAYLOADS as Lt, spikeRecorderToPopulationRateParams as M, normalizeDeclaredProvenanceInputs as Mn, RouteInput as Mt, spikeTrialsToPsthParams as N, normalizeDeclaredProvenanceValue as Nn, RouteResult as Nt, PopulationRatePopulation as O, ProvenanceValueConstraint as On, GetConnectionsDataKind as Ot, AdapterResult as P, provenanceParamConstraintError as Pn, SpikeDataKind as Pt, SynapseModelMeasurementSemantics as Q, SkillContract as Qt, NEST_ADAPTER_LIMITS as R, getExamplePayload as Rt, CorrelationDetectorOptions as S, PROVENANCE_KEY_LABELS as Sn, buildHostRendererInvocation as St, NEST_ANALYSIS_LIMITS as T, ProvenanceKey as Tn, formatInvocationErrors as Tt, getPositionToSceneData as U, NEST_SKILL_REGISTRY as Ut, WeightRecorderTupleSplitResult as V, CORTEXEL_SKILL_VERSION as Vt, multimeterToSceneData as W, PARAM_CONSTRAINT_LANGUAGE as Wt, SYNAPSE_MEASUREMENT_FIELD_SEMANTICS as X, SKILL_REGISTRY as Xt, weightRecorderToSceneData as Y, RequiredProvenanceFlags as Yt, SynapseMeasurementFieldSemantics as Z, STRICT_INVOCATION_POLICY as Zt, synapseCollectionToDelayMatrixParams as _, EngramReceiptBoundCorpusEntityEdgeKind as _n, detectEmptyScene as _t, DelayMatrixOptions as a, listSkills as an, GetPosition3D as at, synapseCollectionToWeightHistogramParams as b, KNOWLEDGE_GRAPH_LIMITS as bn, DeclaredInputs as bt, NormalizedSynapseCollectionSnapshot as c, toPortableJsonSchema as cn, MultimeterEventsSchema as ct, WeightMatrixOptions as d, EngramCorpusEntityEdge as dn, NEST_INPUT_LIMITS as dt, SkillExample as en, CorrelationDetectorStatusSchema as et, getPositionToSpatialMap2DParams as f, EngramCorpusEntityEdgeKind as fn, SpikeRecorderEvents as ft, synapseCollectionToDelayDistributionParams as g, EngramCorpusEvidenceReference as gn, EmptySceneResult as gt, synapseCollectionToConnectionGraphParams as h, EngramCorpusEntityNodeKind as hn, WeightRecorderEventsSchema as ht, DelayDistributionOptions as i, getSkill as in, GetPosition2DSchema as it, spikeRecorderToIsiParams as j, isProvenanceKey as jn, RouteDataKind as jt, PsthAnalysisOptions as k, STRICT_PROVENANCE_POLICY as kn, GetPositionDataKind as kt, SpatialMap2DOptions as l, AdaptEngramCorpusEntityGraphOptions as ln, MultimeterMultiSender as lt, synapseCollectionToAdjacencyMatrixParams as m, EngramCorpusEntityNode as mn, WeightRecorderEvents as mt, ConnectionSnapshotOptions as n, describeSkills as nn, GetConnectionsSchema as nt, NEST_TOPOLOGY_LIMITS as o, provenanceVerificationForContract as on, GetPosition3DSchema as ot, normalizeSynapseCollectionSnapshot as p, EngramCorpusEntityGraphResponse as pn, SpikeRecorderEventsSchema as pt, splitWeightRecorderByRecordedTuple as q, ProvenanceVerification as qt, DegreeDistributionOptions as r, externalProvenanceDisclosure as rn, GetPosition2D as rt, NestTopologyResult as s, skillParamsJsonSchema as sn, MultimeterEvents as st, ConnectionGraphOptions as t, describeSkill as tn, GetConnections as tt, WeightHistogramOptions as u, AdaptEngramCorpusEntityGraphResult as un, MultimeterMultiSenderSchema as ut, synapseCollectionToInDegreeDistributionParams as v, EngramReceiptBoundCorpusEntityGraphResponse as vn, BuildHostRendererInvocationInput as vt, IsiAnalysisOptions as w, PROVENANCE_VALUE_CONSTRAINTS as wn, conservativeProvenance as wt, synapseCollectionToWeightMatrixParams as x, PROVENANCE_KEYS as xn, ProvenanceOverrides as xt, synapseCollectionToOutDegreeDistributionParams as y, adaptEngramCorpusEntityGraph as yn, BuildVizSpecInput as yt, WeightRecorderRecordedTuple as z, getHostRendererExamplePayload as zt };
