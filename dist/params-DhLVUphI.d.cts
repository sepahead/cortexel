import { z } from "zod";
//#region core/skills/params.d.ts
...
//#endregion
export { SnapshotScopeSchema as $, NetworkParams as A, PlasticityParams as B, HISTOGRAM_MASS_TOLERANCE as C, IsiDistributionParamsSchema as D, IsiDistributionParams as E, POPULATION_RATE_ABSOLUTE_TOLERANCE as F, PositionScopeSchema as G, PopulationRateParams as H, POPULATION_RATE_RELATIVE_TOLERANCE as I, RateResponseParams as J, PsthParams as K, PSTH_DERIVED_COUNT_ABSOLUTE_TOLERANCE as L, OutDegreeDistributionParams as M, OutDegreeDistributionParamsSchema as N, KnowledgeGraph3DParams as O, PARAM_LIMITS as P, SnapshotScope as Q, PhasePlaneParams as R, HISTOGRAM_GEOMETRY_ROUNDOFF_ULPS as S, InDegreeDistributionParamsSchema as T, PopulationRateParamsSchema as U, PlasticityParamsSchema as V, PositionScope as W, Rfc3339TimestampSchema as X, RateResponseParamsSchema as Y, SPATIAL_BOUNDS_ROUNDOFF_ULPS as Z, DelayMatrixParams as _, AstrocyteParams as a, SpatialMap2DParamsSchema as at, HISTOGRAM_GEOMETRY_ABSOLUTE_TOLERANCE as b, CORPUS_KNOWLEDGE_GRAPH_NODE_KINDS as c, StimulusResponseParams as ct, ConnectionGraphParams as d, VoltageTraceParamsSchema as dt, Spatial2DParams as et, ConnectionGraphParamsSchema as f, WeightHistogramParams as ft, DelayDistributionParamsSchema as g, DelayDistributionParams as h, WeightMatrixParamsSchema as ht, AnimationReplayParamsSchema as i, SpatialMap2DParams as it, NetworkParamsSchema as j, KnowledgeGraph3DParamsSchema as k, CompartmentalParams as l, StimulusResponseParamsSchema as lt, CorrelogramParamsSchema as m, WeightMatrixParams as mt, AdjacencyMatrixParamsSchema as n, Spatial3DParams as nt, AstrocyteParamsSchema as o, SpikeRasterParams as ot, CorrelogramParams as p, WeightHistogramParamsSchema as pt, PsthParamsSchema as q, AnimationReplayParams as r, Spatial3DParamsSchema as rt, CORPUS_KNOWLEDGE_GRAPH_EDGE_KINDS as s, SpikeRasterParamsSchema as st, AdjacencyMatrixParams as t, Spatial2DParamsSchema as tt, CompartmentalParamsSchema as u, VoltageTraceParams as ut, DelayMatrixParamsSchema as v, InDegreeDistributionParams as w, HISTOGRAM_GEOMETRY_RELATIVE_TOLERANCE as x, GEOMETRY_MAX_ROUNDOFF_FRACTION as y, PhasePlaneParamsSchema as z };
