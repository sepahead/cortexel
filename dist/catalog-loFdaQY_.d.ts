import { m as DisclosureId, w as UncertaintyKind, x as SemanticValidatorId } from "./errors-DLTGhSm-.js";
...
declare const CAPABILITY_IDS: readonly ["cli.catalog", "cli.describe", "cli.identity", "cli.inspect", "cli.migrate", "cli.render", "cli.source", "cli.validate", "cortexel", "cortexel/adapters/nest", "cortexel/authoring", "cortexel/contract", "cortexel/core", "cortexel/figure", "cortexel/knowledge-graph", "cortexel/package.json", "cortexel/react", "cortexel/react/charts", "cortexel/react/knowledge-graph", "cortexel/react/knowledge-graph-dom", "cortexel/render-svg", "cortexel/skills.manifest.json", "nest.animation_replay", "nest.connectivity_matrix", "nest.spatial_2d", "nest.stimulus_response", "network.adjacency_matrix", "network.connection_graph", "network.degree_distribution", "network.delay_distribution", "network.delay_matrix", "network.spatial_map_2d", "network.synaptic_weight_trace", "network.weight_distribution", "network.weight_matrix", "neuro.analog_trace", "neuro.compartment_trace", "neuro.correlogram", "neuro.isi_distribution", "neuro.multisignal_trace", "neuro.phase_plane", "neuro.population_rate", "neuro.psth", "neuro.response_curve", "neuro.spike_raster"];
