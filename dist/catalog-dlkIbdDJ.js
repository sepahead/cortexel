...
*/
const CAPABILITY_AVAILABILITIES = freezeGenerated([
	"packaged",
	"source_only",
	"unavailable"
]);
/** Stable skill ids in deterministic lexicographic order. */
const STABLE_SKILL_IDS = freezeGenerated([
...
const SKILL_CATALOG = freezeGenerated({
	"network.adjacency_matrix": {
...
const CAPABILITY_IDS = freezeGenerated([
	"cli.catalog",
	"cli.describe",
	"cli.identity",
	"cli.inspect",
...
const CAPABILITY_CATALOG = freezeGenerated({
	"cli.catalog": {
		"id": "cli.catalog",
		"kind": "cli",
		"status": "stable",
	...
	"cortexel/react/knowledge-graph-dom": {
		...
		"requiredPeers": ["react"],
		"owner": "Sepehr Mahmoudian",
		"limitations": ["This caption-bound legacy VizSpec inspection surface is not a FigureRequestV1 artifact, evidence authenticator, complete no-JavaScript view, or WCAG/assistive-technology certification."]
	},
	"cortexel/render-svg": {
...
const EXPERIMENTAL_CAPABILITY_IDS = freezeGenerated([]);
const REMOVED_CAPABILITY_IDS = freezeGenerated([
	"nest.animation_replay",
	"nest.connectivity_matrix",
	"nest.spatial_2d",
	"nest.stimulus_response"
...
const LEGACY_SKILL_MAP = freezeGenerated({
	"nest.voltage_trace": {
...
const RENDERERS = freezeGenerated({
	"figure.analog_trace": {
		"id": "figure.analog_trace",
		"revision": 5,
		"status": "stable",
...
const CATEGORICAL_SERIES_STYLES = freezeGenerated([
	{
		"index": 0,
		"color": "#0072b2",
		"dash": "none",
...
const UNCERTAINTY_STYLES_BY_KIND = freezeGenerated({
	"confidence_interval": {
