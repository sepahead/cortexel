...
var KnowledgeGraphNodeSchema = z3.object({
  id: displayText(120),
  kind: z3.enum(["paper", "model", "family"]),
...
var CorrelogramParamsSchema = z3.object({
  ...
  normalization: z3.enum([
    "pearson_coefficient",
    "raw_pair_count",
    "count_per_bin",
    "rate_hz"
  ]),
  correlation_units: z3.enum(["1", "count", "count/bin", "Hz"])
}).strict().superRefine((value, ctx) => {
  equalLengthIssue(
    ctx,
    "correlation",
...
var HostRendererInvocationSchema = z5.object({
  skill: z5.string().trim().min(1).max(80),
...
//# sourceMappingURL=chunk-5F72LNSM.js.map