...
*/
const ERROR_CODES = freezeGenerated([
...
const ERROR_STAGES = freezeGenerated([
	"parse",
	"snapshot",
	"identity",
	"structural",
...
const ERROR_CODE_META = freezeGenerated({
	"JSON_EMPTY_INPUT": {
		"stage": "parse",
		"severity": "error",
...
const UNIT_CODES = freezeGenerated([
	"/1",
	"/A",
	"/S",
	"/V",
...
const QUANTITY_KINDS = freezeGenerated([
	"angle",
	"concentration",
	"conductance",
	"correlation",
...
const UNCERTAINTY_KINDS = freezeGenerated([
	"confidence_interval",
	"credible_interval",
	"ensemble_range",
	"none",
...
const UNIT_ALIASES = freezeGenerated({
	"sec": "s",
	"seconds": "s",
	"second": "s",
	"msec": "ms",
...
const QUANTITY_KIND_DIMENSIONS = freezeGenerated({
	"time": ["time"],
	"duration": ["time"],
...
const DISCLOSURE_RULES = freezeGenerated([
	{
...
const SEMANTIC_VALIDATOR_IDS = freezeGenerated([
...
const NUMERIC_ALGORITHMS = freezeGenerated({
...
const NUMERIC_POLICIES = freezeGenerated({
...
const NUMERIC_POLICY_IDS = freezeGenerated([
	"cortexel_binary64_nominal_steps_v1",
	"cortexel_binary64_spatial_domain_membership_v1",
	"cortexel_binary64_uniform_exposure_bins_v1"
]);
/** Immutable identity algorithms, each bound to the digest of its normative registry entry. */
const CANONICALIZATION_ALGORITHMS = freezeGenerated({ "cortexel_utf16_sorted_unique_identifier_array_rfc8785_v1": {
...
const CANONICALIZATION_IDS = freezeGenerated(["cortexel_utf16_sorted_unique_identifier_array_rfc8785_v1"]);

//#endregion
export { ERROR_CODE_META as a, QUANTITY_KIND_DIMENSIONS as c, UNIT_ALIASES as d, UNIT_CODES as f, ERROR_CODES as i, SEMANTIC_VALIDATOR_IDS as l, CANONICALIZATION_IDS as n, ERROR_STAGES as o, DISCLOSURE_RULES as r, QUANTITY_KINDS as s, CANONICALIZATION_ALGORITHMS as t, UNITS as u };
//# sourceMappingURL=registry-Cmer76Bg.js.map