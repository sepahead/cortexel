...
*/
const BUDGET_PROFILE_IDS = require_deep_freeze.freezeGenerated(["standard", "agent"]);
const BUDGET_PROFILES = require_deep_freeze.freezeGenerated({
	"standard": {
...
const COMPACTION_POLICIES = require_deep_freeze.freezeGenerated({
	"none": {
		"id": "none",
		"revision": 1,
		"appliesTo": ["*"],
...
function restrictLimits(base, overrides) {
	...
	try {
		...
		return require_deep_freeze.freezeGenerated(out);
	}
...
Object.defineProperty(exports, 'DEFAULT_PROFILE', {
  enumerable: true,
  get: function () {
...
Object.defineProperty(exports, 'restrictLimits', {
  enumerable: true,
  get: function () {
    return restrictLimits;
  }
});
Object.defineProperty(exports, 'tryGetBudgetLimits', {
  enumerable: true,
  get: function () {
    return tryGetBudgetLimits;
  }
});
Object.defineProperty(exports, 'trySelectTighterBudgetProfile', {
  enumerable: true,
  get: function () {
    return trySelectTighterBudgetProfile;
  }
});
//# sourceMappingURL=contract-identity-DzgEYCjW.cjs.map