...
//#region src/generated/registry.ts
/**
...
*/
const ERROR_CODES = require_deep_freeze.freezeGenerated([
...
const ERROR_STAGES = require_deep_freeze.freezeGenerated([
	"parse",
	"snapshot",
	"identity",
	"structural",
...
const ERROR_CODE_META = require_deep_freeze.freezeGenerated({
	"JSON_EMPTY_INPUT": {
		"stage": "parse",
		"severity": "error",
...
const UNIT_CODES = require_deep_freeze.freezeGenerated([
	"/1",
	"/A",
	"/S",
	"/V",
...
const QUANTITY_KINDS = require_deep_freeze.freezeGenerated([
	"angle",
	"concentration",
	"conductance",
	"correlation",
...
const UNCERTAINTY_KINDS = require_deep_freeze.freezeGenerated([
	"confidence_interval",
	"credible_interval",
	"ensemble_range",
	"none",
...
const UNITS = require_deep_freeze.freezeGenerated({
	"1": {
		"code": "1",
	...
	"deg": {
		"code": "deg",
		"dimension": "angle",
		"toCanonical": .017453292519943295,
...
const UNIT_ALIASES = require_deep_freeze.freezeGenerated({
	"sec": "s",
	"seconds": "s",
	"second": "s",
	"msec": "ms",
...
const QUANTITY_KIND_DIMENSIONS = require_deep_freeze.freezeGenerated({
	"time": ["time"],
	"duration": ["time"],
	"interspike_interval": ["time"],
	"delay": ["time"],
	"frequency": ["frequency"],
	"firing_rate": ["frequency"],
...
const DISCLOSURE_RULES = require_deep_freeze.freezeGenerated([
	{
...
const SEMANTIC_VALIDATOR_IDS = require_deep_freeze.freezeGenerated([
...
const NUMERIC_ALGORITHMS = require_deep_freeze.freezeGenerated({
	"cortexel_binary64_nominal_interval_candidates_v1": {
		...
		"conformanceVectors": [
			...
			},
			{
				...
				"input": {
					"start": 0x2386f26fc10000,
					"stop": 0x2386f26fc10004,
					"width": 1
				},
				"result": {
					"accepted": false,
...
const NUMERIC_POLICIES = require_deep_freeze.freezeGenerated({
...
const NUMERIC_POLICY_IDS = require_deep_freeze.freezeGenerated([
	"cortexel_binary64_nominal_steps_v1",
	"cortexel_binary64_spatial_domain_membership_v1",
	"cortexel_binary64_uniform_exposure_bins_v1"
]);
/** Immutable identity algorithms, each bound to the digest of its normative registry entry. */
const CANONICALIZATION_ALGORITHMS = require_deep_freeze.freezeGenerated({ "cortexel_utf16_sorted_unique_identifier_array_rfc8785_v1": {
...
const CANONICALIZATION_IDS = require_deep_freeze.freezeGenerated(["cortexel_utf16_sorted_unique_identifier_array_rfc8785_v1"]);

//#endregion
Object.defineProperty(exports, 'CANONICALIZATION_ALGORITHMS', {
  enumerable: true,
  get: function () {
    return CANONICALIZATION_ALGORITHMS;
  }
});
Object.defineProperty(exports, 'CANONICALIZATION_IDS', {
  enumerable: true,
  get: function () {
    return CANONICALIZATION_IDS;
  }
});
Object.defineProperty(exports, 'DISCLOSURE_RULES', {
  enumerable: true,
  get: function () {
...
Object.defineProperty(exports, 'ERROR_CODE_META', {
  enumerable: true,
  get: function () {
    return ERROR_CODE_META;
  }
});
Object.defineProperty(exports, 'ERROR_STAGES', {
  enumerable: true,
  get: function () {
    return ERROR_STAGES;
  }
});
Object.defineProperty(exports, 'QUANTITY_KINDS', {
  enumerable: true,
  get: function () {
    return QUANTITY_KINDS;
  }
});
Object.defineProperty(exports, 'QUANTITY_KIND_DIMENSIONS', {
  enumerable: true,
  get: function () {
    return QUANTITY_KIND_DIMENSIONS;
  }
});
Object.defineProperty(exports, 'SEMANTIC_VALIDATOR_IDS', {
  enumerable: true,
  get: function () {
    return SEMANTIC_VALIDATOR_IDS;
  }
});
...
Object.defineProperty(exports, 'UNIT_CODES', {
  enumerable: true,
  get: function () {
    return UNIT_CODES;
  }
});
//# sourceMappingURL=registry-CCvLcMCj.cjs.map