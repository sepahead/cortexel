...
describe('cli — every command has a closed argv grammar', () => {
  it.each([
    ...
    ['source', 'adapt', 'nest-spike-recorder', '-', '--format'],
    ['source', 'adapt', 'nest-spike-recorder', '-', '--format', 'text'],
    ['source', 'adapt', 'nest-spike-recorder', '-', '--url', 'https://invalid.example'],
    ['validate'],
    ['validate', ''],
    ['validate', 'one', 'two'],
